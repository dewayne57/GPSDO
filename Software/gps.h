...
typedef enum { GPS_PROTOCOL_NMEA = 0, GPS_PROTOCOL_UBX = 1, GPS_PROTOCOL_RTCM = 2 } gps_protocol_t;
...
typedef enum { GPS_INVALID = 0, GPS_VALID = 1 } gps_validity_t;

/* GPS fix types */
typedef enum { GPS_NO_FIX = 0, GPS_2D_FIX = 1, GPS_3D_FIX = 2 } gps_fix_t;
